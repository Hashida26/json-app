...
function ProductList() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("https://json-backend-qcci.onrender.com/laptops")
 ...
 const deleteProduct = async (id) => {
  try {
    const response = await axios.delete(`https://json-backend-qcci.onrender.com/laptops/${id}`);
